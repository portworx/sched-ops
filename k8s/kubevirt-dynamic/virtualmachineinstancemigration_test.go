...
func TestGetMigration(t *testing.T) {
	...
	migration, err := instance.GetVirtualMachineInstanceMigration(testMigrationNamespace, testMigrationName)
	if err != nil {
...
func TestListMigrations(t *testing.T) {
	...
	require.NotNil(t, instance, "instance should be initialized")
	migrations, err := instance.ListVirtualMachineInstanceMigrations(testMigrationNamespace)
	if err != nil {
