...
import (
	...
	//v1alpha4 "sigs.k8s.io/cluster-api/pkg/apis/deprecated/v1alpha4"
...
var (
	machineResource = schema.GroupVersionResource{Group: "cluster.k8s.io", Version: "v1alpha4", Resource: "machines"}
)
...
type MachineOps interface {
	...
	ListMachines(ctx context.Context) (*v1alpha4.MachineList, error)
	// GetMachine returns a machine for the given name
	GetMachine(ctx context.Context, name string) (*v1alpha4.Machine, error)
	// DeleteMachine delete machine for given name
	DeleteMachine(ctx context.Context, name string) error
}

// ListMachines lists all machines in kubernetes cluster
func (c *Client) ListMachines(ctx context.Context) (*v1alpha4.MachineList, error) {
	...
	machineList := &v1alpha4.MachineList{}
...
// GetMachine returns a machine for the given name
func (c *Client) GetMachine(ctx context.Context, name string) (*v1alpha4.Machine, error) {
	if err := c.initClient(); err != nil {
		return nil, err
	}
