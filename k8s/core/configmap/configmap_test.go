...
func TestGetConfigMap(t *testing.T) {
	...
	cm, err := New("px-configmaps-test-get", configData, testLockTimeout, 5, 0, 0)
...
func TestDeleteConfigMap(t *testing.T) {
	...
	cm, err := New("px-configmaps-test-delete", configData, testLockTimeout, 5, 0, 0)
	require.NoError(t, err, "Unexpected error in creating configmap")
...
func TestIncrementGeneration(t *testing.T) {
	...
	cmIntf, err := New("px-configmaps-test-increment", configData, testLockTimeout, 5, 0, 0)
	require.NoError(t, err, "Unexpected error in creating configmap")
