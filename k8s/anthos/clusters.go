...
var (
	clusterResource = schema.GroupVersionResource{Group: "cluster.x-k8s.io", Version: "v1beta1", Resource: "clusters"}
)
...
type ClusterOps interface {
	...
	ListCluster(ctx context.Context) (*clusterv1.ClusterList, error)
	// GetCluster returns a cluster for the given name
	GetCluster(ctx context.Context, name, namespace string) (*clusterv1.Cluster, error)
	// GetClusterStatus return the given cluster status
	GetClusterStatus(ctx context.Context, name, namespace string) (*clusterv1.ClusterStatus, error)
...
// ListCluster lists all kubernetes clusters
func (c *Client) ListCluster(ctx context.Context) (*clusterv1.ClusterList, error) {
...
// GetCluster returns a cluster for the given name
func (c *Client) GetCluster(ctx context.Context, name, namespace string) (*clusterv1.Cluster, error) {
	if err := c.initClient(); err != nil {
		return nil, err
	}
...
// GetClusterStatus return the given cluster status
func (c *Client) GetClusterStatus(ctx context.Context, name, namespace string) (*clusterv1.ClusterStatus, error) {
