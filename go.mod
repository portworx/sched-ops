...
require (
	...
	github.com/pure-px/px-operator v0.0.0-20241017062314-ac76a09ab505
...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.30.4
	...
	kubevirt.io/containerized-data-importer-api v1.57.0-alpha1 => kubevirt.io/containerized-data-importer-api v1.60.1
)
