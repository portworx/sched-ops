...
var (
	machineResource = schema.GroupVersionResource{Group: "cluster.x-k8s.io", Version: "v1beta1", Resource: "machines"}
)
...
type MachineOps interface {
	...
	ListMachines(ctx context.Context) (*clusterv1.MachineList, error)
	// GetMachine returns a machine for the given name
	GetMachine(ctx context.Context, name string) (*clusterv1.Machine, error)
	// DeleteMachine delete machine for given name
	DeleteMachine(ctx context.Context, name string) error
}

// ListMachines lists all machines in kubernetes cluster
func (c *Client) ListMachines(ctx context.Context) (*clusterv1.MachineList, error) {
...
// GetMachine returns a machine for the given name
func (c *Client) GetMachine(ctx context.Context, name string) (*clusterv1.Machine, error) {
	if err := c.initClient(); err != nil {
		return nil, err
	}
