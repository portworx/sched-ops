...
func (c *Client) CreatePodSecurityPolicy(policy *policyv1beta1.PodSecurityPolicy) (*policyv1beta1.PodSecurityPolicy, error) {
	...
	return c.policy.PolicyV1beta1().PodSecurityPolicies().Create(context.TODO(), policy, metav1.CreateOptions{})
}
...
func (c *Client) GetPodSecurityPolicy(name string) (*policyv1beta1.PodSecurityPolicy, error) {
	...
	return c.policy.PolicyV1beta1().PodSecurityPolicies().Get(context.TODO(), name, metav1.GetOptions{})
}
...
func (c *Client) ListPodSecurityPolicies() (*policyv1beta1.PodSecurityPolicyList, error) {
	...
	return c.policy.PolicyV1beta1().PodSecurityPolicies().List(context.TODO(), metav1.ListOptions{})
}
...
func (c *Client) UpdatePodSecurityPolicy(policy *policyv1beta1.PodSecurityPolicy) (*policyv1beta1.PodSecurityPolicy, error) {
	...
	return c.policy.PolicyV1beta1().PodSecurityPolicies().Update(context.TODO(), policy, metav1.UpdateOptions{})
}
...
func (c *Client) DeletePodSecurityPolicy(name string) error {
	...
	return c.policy.PolicyV1beta1().PodSecurityPolicies().Delete(context.TODO(), name, metav1.DeleteOptions{})
}
