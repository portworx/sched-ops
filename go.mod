...
require (
	...
	github.com/libopenstorage/external-storage v5.2.0+incompatible
...
replace (
	github.com/libopenstorage/external-storage => github.com/libopenstorage/external-storage v0.20.4-rc1
