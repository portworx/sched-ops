...
func (c *Client) IsKubevirtCRDInstalled() error {
	_, err := c.kubevirt.ExtensionsClient().ApiextensionsV1().CustomResourceDefinitions().Get(context.Background(), VirtualMachineCRD, k8smetav1.GetOptions{})
	if err != nil {
...
func (c *Client) ListVirtualMachines(namespace string) (*kubevirtv1.VirtualMachineList, error) {
	...
	return c.kubevirt.VirtualMachine(namespace).List(context.Background(), k8smetav1.ListOptions{})
}
...
func (c *Client) BatchListVirtualMachines(namespace string, listOptions *k8smetav1.ListOptions) (*kubevirtv1.VirtualMachineList, error) {
	...
	return c.kubevirt.VirtualMachine(namespace).List(context.Background(), *listOptions)
}
...
func (c *Client) CreateVirtualMachine(vm *kubevirtv1.VirtualMachine) (*kubevirtv1.VirtualMachine, error) {
	...
	return c.kubevirt.VirtualMachine(vm.GetNamespace()).Create(context.Background(), vm, k8smetav1.CreateOptions{})
}
...
func (c *Client) GetVirtualMachine(name string, namespace string) (*kubevirtv1.VirtualMachine, error) {
	...
	return c.kubevirt.VirtualMachine(namespace).Get(context.Background(), name, k8smetav1.GetOptions{})
}
...
func (c *Client) DeleteVirtualMachine(name, namespace string) error {
	...
	return c.kubevirt.VirtualMachine(namespace).Delete(context.Background(), name, k8smetav1.DeleteOptions{})
}
...
func (c *Client) StartVirtualMachine(vm *kubevirtv1.VirtualMachine) error {
	...
	return c.kubevirt.VirtualMachine(vm.GetNamespace()).Start(context.Background(), vm.GetName(), &kubevirtv1.StartOptions{})
}
...
func (c *Client) StopVirtualMachine(vm *kubevirtv1.VirtualMachine) error {
	...
	return c.kubevirt.VirtualMachine(vm.GetNamespace()).Stop(context.Background(), vm.GetName(), &kubevirtv1.StopOptions{})
}
...
func (c *Client) RestartVirtualMachine(vm *kubevirtv1.VirtualMachine) error {
	...
	return c.kubevirt.VirtualMachine(vm.GetNamespace()).Restart(context.Background(), vm.GetName(), &kubevirtv1.RestartOptions{})
}
...
func (c *Client) UpdateVirtualMachine(vm *kubevirtv1.VirtualMachine) (*kubevirtv1.VirtualMachine, error) {
	...
	return c.kubevirt.VirtualMachine(vm.GetNamespace()).Update(context.Background(), vm, k8smetav1.UpdateOptions{})
}
